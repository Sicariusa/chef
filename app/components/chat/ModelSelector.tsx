...
> = {
  ...
  'grok-free': {
    name: 'Grok 4 Fast (Free) - Deprecated',
    provider: 'openrouter',
    requireKey: true,
  },
  'claude-3-5-haiku': {
  ...
  'qwen-coder': {
    name: 'Qwen3 Coder (Free, No Tools)',
    provider: 'openrouter',
    requireKey: true,
  },
  'qwen-2.5-coder-32b': {
    name: 'Qwen 2.5 Coder 32B (Free, No Tools)',
    provider: 'openrouter',
    requireKey: true,
  },
  ...
  'llama-3.3-70b': {
    name: 'Llama 3.3 70B (Free, No Tools)',
    provider: 'openrouter',
    requireKey: true,
  },
  'codestral-latest': {
    name: 'Codestral Latest (Free)',
    provider: 'openrouter',
    requireKey: true,
  },
  'nemotron-nano-9b-v2': {
